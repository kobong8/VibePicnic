...
Options:
  --season <name>     계절 선택: spring, summer, autumn, winter, sunrise, auto (기본: auto)
...
Controls (일반 모드):
  ← →               바람 방향/세기 조절
  ↑ ↓               파티클 밀도 조절
  1-5               계절 전환 (1:봄 2:여름 3:가을 4:겨울 5:일출)
  r                 바닥 리셋
  q / ESC           종료
...
const validSeasons = ["auto", "spring", "summer", "autumn", "winter", "sunrise"];
